...
public class Person implements Comparable {
  ...
  /** 
   * Compares the name of this person to another
   *
   * @param obj	another person object
   * @return the value 0 if the argument string is equal to the input person's name;
   *      a value less than 0 if this string is lexicographically less than 
   *      the input person's name; and a value greater than 0 if this string is
   *      lexicographically greater than the input person's name.
   */
